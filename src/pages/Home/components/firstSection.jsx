        ...
        <>
            ...
            <Link className='' to={"/"}>
                ...
                <div className="flex flex-row items-center gap-2 ">
                    <input className='h-14 w-[40vw] rounded-3xl bg-slate-50 p-5 text-xl active:border-none active:outline-none border-none outline-none ' type="text" autoFocus />
                    ...
                    <div className="film1 film text-center ">
                        ...
                        <Link className="div-btn" to={"/about"}>More info</Link>
                            <div className='div-filter'>
                                ...
                                <div className=' flex flex-col justify-center justify-between h-[223px] p-3'>
